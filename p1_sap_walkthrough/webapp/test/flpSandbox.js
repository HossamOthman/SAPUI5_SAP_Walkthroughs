		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Walkthrough",
									"targetURL": "#edup1sapwalkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"edup1sapwalkthrough-display": {
								"semanticObject": "edup1sapwalkthrough",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=edu.p1sapwalkthrough",
									"url": sap.ui.require.toUrl("edu/p1sapwalkthrough")
								}
							}
						}
					}
